...
| Wave 4 — persistence & polish | ✅ Complete | `wave4-complete` tag | All Phase 0 + Phase A + Phase B + 7 polish commits landed. 339 tests passing. Tagged release at https://github.com/duysqubix/snowboy/releases/tag/wave4-complete. See [`snowboy-wave4.md`](snowboy-wave4.md) + [`snowboy-handoff-2026-05-20.md`](snowboy-handoff-2026-05-20.md). |
| **Wave 5 — packaging & release** | ⏳ **Next** | — | 5 tasks (T5.1–T5.5) — Linux/Windows/macOS builders, GH Actions CI/release, README |
